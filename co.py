...
#	os.system("mkdir /results")
	try:
		...
		os.system("echo 'Opera/9.80 (Android; Opera Mini/32.0.2254/85. U; id) Presto/2.12.423 Version/12.16 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]' >> .ua.txt")
		os.system("echo 'Opera/9.80 (Android; Opera Mini/32.0.2254/85. U; id) Presto/2.12.423 Version/12.16 (KHTML, like Gecko) Safari/420+ [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109;]' >> .ua")
	os.system("clear")
	print("""\x1b[1;96m┌───────────────────────────────────────────────────────────────┐
│                                                               │
│    ██████╗ ██╗ ██████╗██╗  ██╗██╗   ██╗    ██╗  ██╗██████╗    │
...
def login():
	...
	try:
		...
		print("\n \033[44m PILIHAN METHODE LOGIN:.........?")
		print(" \033[0;96m[\033[0;96m1\x1b[1;95m] LOGIN TOKEN ")
		print(" \033[0;96m[\033[0;96m2\x1b[1;95m] LOGIN COOKIE")
		ask = raw_input("\n \033[0;96m[\033[0;93m?\x1b[1;93m] Pilih Salah Satu! : ")
		if ask =="":
			login()
...
def cookie():
	...
	try:
		...
		'user-agent'                : 'Opera/9.80 (Android; Opera Mini/32.0.2254/85. U; id) Presto/2.12.423 Version/12.16', # Jangan Di Ganti Ea Anjink.
